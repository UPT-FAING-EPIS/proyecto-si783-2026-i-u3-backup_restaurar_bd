...
describe('Sidebar Component', () => {
  ...
  it('renderiza los 4 botones de navegación', async () => {
    await act(async () => {
      render(<Sidebar currentView="dashboard" setView={mockSetView} />);
    });
  ...
  it('marca el botón Dashboard como activo por defecto', async () => {
    await act(async () => {
      render(<Sidebar currentView="dashboard" setView={mockSetView} />);
    });
  ...
  it('marca Conexiones como activo cuando currentView es connections', async () => {
    await act(async () => {
  ...
  it('llama a setView al hacer clic en un botón de navegación', async () => {
    await act(async () => {
      render(<Sidebar currentView="dashboard" setView={mockSetView} />);
    });
  ...
  it('llama a setView con "backup" al hacer clic en Generar Backup', async () => {
    await act(async () => {
      render(<Sidebar currentView="dashboard" setView={mockSetView} />);
    });
  ...
  it('llama a setView con "history" al hacer clic en Historial', async () => {
    await act(async () => {
      render(<Sidebar currentView="dashboard" setView={mockSetView} />);
    });
  ...
  it('los botones inactivos tienen estilo text-muted', async () => {
    await act(async () => {
      render(<Sidebar currentView="dashboard" setView={mockSetView} />);
    });
